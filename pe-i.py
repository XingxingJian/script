...
rule select_unmap_ppmi:
  input:
    r1=config['samples']["input1"],
    r2=config['samples']["input2"]
  output:
...
rule quality_trim:
  ...
  shell: "bbduk.sh in1={input[0]} in2={input[1]} out1={output[0]} out2={output[1]} threads={Threads} qtrim=rl trimq=10 overwrite=t"
